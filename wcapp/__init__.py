...
# print len(sqlorm.wc_DSS.query.all())

# dss_columns = [key for key in sqlorm.wc_DSS.__dict__ if not key.startswith('_')] 

# values = dict((dss_column, 0) for dss_column in dss_columns)
